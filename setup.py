...
setup(
  name = 'jenkins-scrapper',         # How you named your package folder (MyLib)
  packages = ['jenkins-scrapper'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'jenkins-scrapper',   # Give a short description about your library
  author = 'Shreyas Dange',                   # Type in your name
  author_email = 'shred@gmail.com',      # Type in your E-Mail
